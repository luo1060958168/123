...
public class ResourceServiceImpl implements ResourceService {
    ...
    public List<Map> findListMap() {
        ...
        List<Map> listMap = getListMap(all, 0);
        return listMap;
    }
     ...
     * @return
     */
    private List<Map> getListMap(List<Resource> resourceList, Integer parentId){
        List<Map> mapList = new ArrayList<Map>();
        for (Resource resource : resourceList) {
            if (parentId.equals(resource.getId())){
                Map<String, Object> map = new HashMap<String, Object>();
                map.put("children",getListMap(resourceList,resource.getId()));
